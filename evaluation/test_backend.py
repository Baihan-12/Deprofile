...
from repo_paths import DATA_DIR, EVAL_DIR

app = FastAPI()
# =========================
# 1. 后端加载数据
# =========================
with open(DATA_DIR / "main_select_profiles.json", "r", encoding="utf-8") as f:
...
def chat_api(req: ChatRequest):
    ...
    prompts = generate_patient_prompts({req.profile_id: profile}, req.language)
...
# =========================
SAVE_DIR = str(EVAL_DIR / "ablation")
BATCH_DIR = SAVE_DIR
