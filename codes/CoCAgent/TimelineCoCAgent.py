...
_DEFAULT_TIMELINE_ROOT = os.path.join(_REPO_ROOT, "timeline")
...
def build_profile_timeline_memory_coc(
    ...
    """
    save_dir = os.path.join(_REPO_ROOT, "timeline_memory") + os.sep
...
if __name__ == "__main__":
    cuda_index = 2
    qwen = HFQwenChatClient(model_name_or_path="/hpc_stor03/sjtu_home/baihan.li/.cache/modelscope/hub/models/Qwen/Qwen3-8B", cuda_index=cuda_index)
    debug = False
    profilejson = json.load(open("/hpc_stor03/sjtu_home/baihan.li/deprofile/ACL_agent/data/main_select_profiles_2.json", "r"))
