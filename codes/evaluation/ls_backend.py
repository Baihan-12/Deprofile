import os
    # uvicorn ls_backend:app --host 0.0.0.0 --port 8003
    # python3 run_batch.py -i G0.5 -u http://localhost:8003/api/run_batch 
...
# =========================
# SAVE_DIR = "/hpc_stor03/sjtu_home/baihan.li/deprofile/ACL_agent/evaluation/llama-3.1-8B-ablation"
# BATCH_DIR = "/hpc_stor03/sjtu_home/baihan.li/deprofile/ACL_agent/evaluation/llama-3.1-8B-ablation"
