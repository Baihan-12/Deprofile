...
from prompts.personality_traits import big_five_prompt
from prompts.risk import risk_prompt
from prompts.clinical import clinical_prompt, clinical_prompt_no_timeline

random.seed(42)
# RANDOM_DIALOGUES_DIR = "/hpc_stor03/sjtu_home/baihan.li/deprofile/ACL_agent/evaluation/dialogues"
...
def load_clinical_dialogues(profile_id, profile, dir = os.path.normpath(os.path.join(os.path.dirname(__file__), "..", "..", "DEPROFILE", "dialogues_sample", "assessment")), max_dialogues_num = 10):
    """
...
def load_consultation_dialogues(profile_id, profile, dir = os.path.normpath(os.path.join(os.path.dirname(__file__), "..", "..", "DEPROFILE", "dialogues_sample", "counseling")), max_dialogues_num = 10):
    """
    load clinical dialogues from d4 dataset
    save both doctor and patient messages
    output the reference messages with max_dialogues_num dialogues
