import os
    # uvicorn test_backend:app --host 0.0.0.0 --port 800
...
# =========================
# 确保路径正确
with open("/hpc_stor03/sjtu_home/baihan.li/deprofile/ACL_agent/data/main_select_profiles.json", "r", encoding="utf-8") as f:
    ALL_PROFILES = json.load(f)

# =========================
# 2. 加载模型
# =========================
MODEL_DIR = "/hpc_stor03/sjtu_home/baihan.li/.cache/modelscope/hub/models/Qwen/Qwen3-8B"
...
def chat_api(req: ChatRequest):
    ...
    prompts = generate_patient_prompts(profile, req.language)
...
# =========================
SAVE_DIR = "/hpc_stor03/sjtu_home/baihan.li/deprofile/ACL_agent/evaluation/ablation"
BATCH_DIR = "/hpc_stor03/sjtu_home/baihan.li/deprofile/ACL_agent/evaluation/ablation"
...
def run_batch_task(req: BatchRunRequest, timestamp: str):
    ...
    for idx, (pid, profile) in enumerate(ALL_PROFILES.items()):
        ...
        for q in req.questions:
            try:
                reply = get_model_reply(system_prompt, history, q)
                # 注意：这里我们将问答加入历史，意味着下一个问题会有上下文
